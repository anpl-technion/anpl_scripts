#!/bin/bash
VERSION=2.1
FILE_NAME="realsense_dist-v$VERSION.zip"
DIR_EXTRACT="realsense_dist"
RVIZ="~/ANPL/infrastructureproject/rviz_files"
INSTALL_DIR="/opt/ros/$ROS_DISTRO/share/realsense"
